...
public partial class GameEntity {
    ...
    public System.Collections.Generic.List<Code.Gameplay.Features.Effect.EffectSetup> EffectSetups { get { return effectSetups.Value; } }
    public bool hasEffectSetups { get { return HasComponent(GameComponentsLookup.EffectSetups); } }

    public GameEntity AddEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effect.EffectSetup> newValue) {
    ...
    public GameEntity ReplaceEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effect.EffectSetup> newValue) {
        var index = GameComponentsLookup.EffectSetups;
        var component = (Code.Gameplay.Features.Armaments.EffectSetups)CreateComponent(index, typeof(Code.Gameplay.Features.Armaments.EffectSetups));
        component.Value = newValue;
