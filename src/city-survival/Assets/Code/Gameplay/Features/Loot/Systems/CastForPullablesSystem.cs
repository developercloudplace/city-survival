...
namespace Code.Gameplay.Features.Loot.Systems
{
    public class CastForPullablesSystem : IExecuteSystem
    {
        ...
        public void Execute()
        {
            ...
            {
                for (int i = 0; i < LootingRadius(entity); i++)
                {
        ...
        private int LootingRadius(GameEntity entity)
        {
            return _physicsService.SphereCastNonAlloc(entity.WorldPosition,
                radius: entity.PickupRadius, _layerMask, _hitBuffer);
        }
    }
}